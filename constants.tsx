...
export const PACKAGES: Package[] = [
  { id: '1', nameEn: 'Goti Student Unlimited', nameBn: 'গতি স্টুডেন্ট আনলিমিটেড', durationEn: '30 days', durationBn: '৩০ দিন', price: 180 },
  { id: '2', nameEn: 'Goti Family Unlimited', nameBn: 'গতি ফ্যামিলি আনলিমিটেড', durationEn: '30 days', durationBn: '৩০ দিন', price: 300 },
  { id: '3', nameEn: 'Goti Plus+ Unlimited', nameBn: 'গতি প্লাস+ আনলিমিটেড', durationEn: '30 days', durationBn: '৩০ দিন', price: 500 },
  { id: '4', nameEn: 'Goti Regular Unlimited (7d)', nameBn: 'গতি রেগুলার আনলিমিটেড (৭ দিন)', durationEn: '7 days', durationBn: '৭ দিন', price: 50 },
  { id: '5', nameEn: 'Goti Regular Unlimited (15d)', nameBn: 'গতি রেগুলার আনলিমিটেড (১৫ দিন)', durationEn: '15 days', durationBn: '১৫ দিন', price: 90 },
];
